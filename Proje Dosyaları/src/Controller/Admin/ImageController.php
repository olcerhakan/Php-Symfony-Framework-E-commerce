...
class ImageController extends AbstractController
{
    ...
    /**
     * @Route("/new/{ppid}", name="admin_image_new", methods="GET|POST")
     */
    public function new(Request $request,$ppid,ImageRepository $imagerepository): Response
    {
        //echo "Test: $ppid";
        //die();

        $imagelist= $imagerepository->findBy(['product_id' => $ppid]);
        ...
        if ($request->files->get('imagename')) {
            ...
            return $this->redirectToRoute('admin_image_new',array('ppid' => $ppid));
        }
    ...
    /**
     * @Route("/{id}/{ppid}", name="admin_image_del", methods="GET")
     */
    public function del(Request $request, Image $image,$ppid): Response
    {
