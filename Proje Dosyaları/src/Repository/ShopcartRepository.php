...
class ShopcartRepository extends ServiceEntityRepository
{
    ...
    */
    ...
    public function getUserShopCart($userid): array    //id sini gönderdiğim kullanıcının product ile ilişkilendirerek geri gönderir
    {
        $em = $this->getEntityManager();
        $query= $em->createQuery('
            SELECT p.title,p.price,s.quantity,s.productid,s.userid,(p.sprice*s.quantity) as total
